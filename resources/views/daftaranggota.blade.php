<x-layout>
    ...
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <h1 class="text-2xl font-bold w-full sm:w-auto">Daftar Anggota</h1>
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2 w-full sm:w-auto">
            <!-- Form Pencarian -->
            <form action="{{ route('index.anggota') }}" method="GET" class="flex items-center gap-2 w-full sm:w-auto">
            ...
            <table class="min-w-full bg-white border border-gray-300 text-sm sm:text-base">
                <thead>
                    <tr>
                        ...
                        <th class="py-2 px-4 border-b bg-gray-800 text-white font-bold ">Nama</th>
                        <th class="py-2 px-4 border-b bg-gray-800 text-white font-bold">Jenis Kelamin</th>
                        <th class="py-2 px-4 border-b bg-gray-800 text-white font-bold">Alamat</th>
                        <th class="py-2 px-4 border-b bg-gray-800 text-white font-bold">Status</th>
